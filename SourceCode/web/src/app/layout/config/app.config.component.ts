...
import { MenuService } from "../../auth/services/app.menu.service";
import {
  ColorScheme,
  LayoutService,
  MenuMode,
  TopbarColorScheme,
} from "../../core/services/app.layout.service";
...
export class AppConfigComponent implements OnInit {
  ...
  set topbarTheme(_val: TopbarColorScheme) {
    if (this.layoutService.isHorizontal()) {
      this.layoutService.config().menuTheme =
        _val === "transparent" ? this.layoutService.config().colorScheme : _val;
    }
